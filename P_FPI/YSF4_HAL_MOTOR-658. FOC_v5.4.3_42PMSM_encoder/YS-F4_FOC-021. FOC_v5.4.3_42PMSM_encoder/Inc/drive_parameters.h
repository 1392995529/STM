...
/*** Encoder **********************/                                                                                                           
#define ENC_MEAS_ERRORS_BEFORE_FAULTS   200 /*!< Number of failed   
...
#define PID_TORQUE_KP_DEFAULT         100       //Iq KP
#define PID_TORQUE_KI_DEFAULT         50        //Iq KI
#define PID_TORQUE_KD_DEFAULT         100        
#define PID_FLUX_KP_DEFAULT           100       //Id KP
#define PID_FLUX_KI_DEFAULT           100       //Id KI
#define PID_FLUX_KD_DEFAULT           100       

                                                             
#define FUZZYPID_SPEED_KE_DEFAULT     0.4
#define FUZZYPID_SPEED_KEC_DEFAULT    0.02
#define FUZZYPID_SPEED_KUP_DEFAULT    0
#define FUZZYPID_SPEED_KUI_DEFAULT    0
#define FUZZYPID_SPEED_alphe_DEFAULT  1
#define FUZZYPID_SPEED_alphec_DEFAULT  1
/* Torque/Flux control loop gains dividers*/
#define TF_KPDIV                      1024      
#define TF_KIDIV                      16384     //决定积分限幅
...
#define PID_SPEED_KP_DEFAULT          200/(SPEED_UNIT/60) /* Workbench compute the gain for 01Hz unit*/  //速度KP
#define PID_SPEED_KI_DEFAULT          120/(SPEED_UNIT/60) /* Workbench compute the gain for 01Hz unit*/   //速度KI
...
#define DEFAULT_CONTROL_MODE           STC_SPEED_MODE /*!< STC_TORQUE_MODE or 
                                                        STC_SPEED_MODE */
#define DEFAULT_TARGET_SPEED_RPM      100
...
#define FINAL_I_ALIGNMENT               3113 /*!< s16A */
