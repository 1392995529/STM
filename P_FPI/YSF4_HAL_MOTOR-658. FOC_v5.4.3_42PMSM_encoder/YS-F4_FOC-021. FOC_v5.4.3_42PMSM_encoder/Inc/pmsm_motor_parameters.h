...
#define RS                     0.19 /* Stator resistance , ohm*/
#define LS                     0.000110 /* Stator inductance, H
...
#define NOMINAL_CURRENT         5588
#define MOTOR_MAX_SPEED_RPM     6000 /*!< Maximum rated speed  */
#define MOTOR_VOLTAGE_CONSTANT  3.0 /*!< Volts RMS ph-ph /kRPM */
#define ID_DEMAG                -5588 /*!< Demagnetization current */
