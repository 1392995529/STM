...
#define PID_FLUX_KI_DEFAULT           150       //Id KI
#define PID_FLUX_KD_DEFAULT           100

                                                                
#define FUZZYPID_SPEED_KE_DEFAULT     0.01
#define FUZZYPID_SPEED_KEC_DEFAULT    0.01
...
#define PID_SPEED_KP_DEFAULT          300/(SPEED_UNIT/60) /* Workbench compute the gain for 01Hz unit*/
#define PID_SPEED_KI_DEFAULT          120/(SPEED_UNIT/60) /* Workbench compute the gain for 01Hz unit*/
...
#define FINAL_I_ALIGNMENT               3991 /*!< s16A */
