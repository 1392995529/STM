...
typedef enum
{
  ...
  MC_PROTOCOL_REG_POSITION_KVFF,         /* 137 */   //kvff
  MC_PROTOCOL_REG_POSITION_KAFF,         /* 138 */   //kaff
  MC_PROTOCOL_REG_SPEED_KE,              /* 139 */   //speed_ke
  MC_PROTOCOL_REG_SPEED_KEC,             /* 140 */   //speed_kec
  MC_PROTOCOL_REG_SPEED_KUP,             /* 141 */   //speed_kup
  MC_PROTOCOL_REG_SPEED_KUI,             /* 142 */   //speed_kui
  MC_PROTOCOL_REG_POSITION_KE,           /* 143 */   //position_ke
  MC_PROTOCOL_REG_POSITION_KEC,          /* 144 */   //position_kec
  MC_PROTOCOL_REG_POSITION_KUP,          /* 145 */   //position_kup
  MC_PROTOCOL_REG_POSITION_KUI,          /* 146 */   //position_kui
...
bool UI_SetReg(UI_Handle_t *pHandle, MC_Protocol_REG_t bRegID, int32_t wValue);
 bool UI_SetRegFloat(MC_Protocol_REG_t bRegID, float wValue);
