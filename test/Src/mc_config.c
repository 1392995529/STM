...
/**
  ...
  */
/*PID_Handle_t PIDSpeedHandle_M1 =         //速度环PI控制句柄
{
...
PID_Handle_t FUZZYPIDSpeedHandle_M1 =     //速度环FUZZYPI控制句柄
{
  .hDefKpGain          = (int16_t)PID_SPEED_KP_DEFAULT,
  .hDefKiGain          = (int16_t)PID_SPEED_KI_DEFAULT, 
  .wUpperIntegralLimit = (int32_t)IQMAX * (int32_t)SP_KIDIV,
  ...
  .hKdDivisor           = 0x0000U,
  .hKdDivisorPOW2       = 0x0000U,
  .hDefKe               = (float)FUZZYPID_SPEED_KE_DEFAULT,
  .hDefKec              = (float)FUZZYPID_SPEED_KEC_DEFAULT,
  .hDefKup              = (int16_t)FUZZYPID_SPEED_KUP_DEFAULT,
  .hDefKui              = (int16_t)FUZZYPID_SPEED_KUI_DEFAULT,
  //.alphae               = (float)FUZZYPID_SPEED_alphe_DEFAULT,
  //.alphae               = (float)FUZZYPID_SPEED_alphec_DEFAULT,
};
/**
  * @brief  PI / PID Iq loop parameters Motor 1
  */
PID_Handle_t PIDIqHandle_M1 =      //电流环Iq PI控制句柄
{
...
/**
  ...
  */
PID_Handle_t PIDIdHandle_M1 =      //电流环Id PI控制句柄
{
